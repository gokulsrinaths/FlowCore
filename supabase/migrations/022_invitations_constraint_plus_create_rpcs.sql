-- Fix 23514 when constraint was updated (021) but Postgres still runs 017 invite RPCs that INSERT 'pending'.
-- New CHECK rejects 'pending' → same error until these functions insert 'invited'.

-- ---------------------------------------------------------------------------
-- 1. Constraint + row cleanup (idempotent)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 2. Invite RPCs must use 'invited' + DELETE open rows by invited/registered
-- ---------------------------------------------------------------------------
